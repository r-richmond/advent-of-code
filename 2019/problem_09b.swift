...
let CompTest1 = Computer(memory: op_code_test_1, input: [1])
let CompTest2 = Computer(memory: op_code_test_2, input: [1])
let CompTest3 = Computer(memory: op_code_test_3, input: [1])
print("test 1 passed:", CompTest1.process() == op_code_test_1)
print("test 2 passed:", CompTest2.process() == [1219070632396864])
print("test 3 passed:", CompTest3.process() == [1125899906842624])

let Comp = Computer(memory: op_code, input:[1])
print("Part 1: \(Comp.process())")
Comp.resetMemory()
Comp.input = [2]
print("Part 2: \(Comp.process())")
